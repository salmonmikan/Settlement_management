...
<%
  BusinessTripBean bt = (BusinessTripBean) request.getAttribute("tripBean");
...
<div class="page-container" style="display: flex; flex-direction: column; gap: 5px;">
  ...
  <!-- Step2 -->
  <div class="form-section" style="display: flex; flex-direction: column; gap: 5px;">
    ...
    %>
      <div class="form-section">
        ...
        <ul>
          ...
          %>
            <li>
              <a href="<%= request.getContextPath() + "/uploads/" + file %>" target="_blank"><%= original %></a>
            </li>
