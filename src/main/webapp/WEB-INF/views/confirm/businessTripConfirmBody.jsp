...
<%
  ...
  Map<String, List<String>> receiptMap;
  if (isDetailMode) {
    receiptMap = (Map<String, List<String>>) request.getAttribute("receiptMap");  // ✅ từ servlet detail
  } else {
    receiptMap = (Map<String, List<String>>) session.getAttribute("receiptMap");  // ✅ từ khi đăng ký
  }
%>
<style>
	.memo-block {
		...
		%>
		  <div class="form-section">
		    ...
		    <ul>
		      ...
		      %>
		        <li>
		          <a href="<%= request.getContextPath() + "/" + file %>" target="_blank"><%= original %></a>
