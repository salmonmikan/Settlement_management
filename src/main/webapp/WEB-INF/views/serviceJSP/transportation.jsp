...
<body>
  <div class="page-container">
    <div class="content-container">
      ...
      <form method="post" action="transportationControl" enctype="multipart/form-data">
        ...
        <div style="display: flex; flex-direction: column; gap: 10px" id="transportation-container">
          <c:forEach var="detail" items="${transportationApp.details}" varStatus="loop">
            <div class="form-section transportation-block" style="position: relative;">
              ...
              <div class="form-group">
                <label>出発</label>
                <input type="text" name="departure[]" placeholder="例:東京駅" value="${detail.departure}">
              </div>

              <div class="form-group">
                <label>到着</label>
                <input type="text" name="arrival[]" placeholder="例:大阪駅" value="${detail.arrival}">
              </div>
              ...
              <div class="form-group">
                <label>金額（税込）</label>
                <input type="number" name="fareAmount[]" value="${detail.fareAmount}">
              </div>
              ...
              <div class="form-group">
                <label>合計</label>
                <input type="number" name="expenseTotal[]" value="${detail.expenseTotal}" readonly>
              </div>
  ...
  <template id="transportation-template">
    <div class="form-section transportation-block" style="position: relative;">
      ...
      <div class="form-group">
        <label>訪問先</label>
        <input type="text" name="destination[]" placeholder="例: ABC株式会社" required>
      </div>
      ...
      <div class="form-group">
        <label>到着</label>
        <input type="text" name="arrival[]" placeholder="例:大阪駅">
      </div>
      ...
      <div class="form-group">
        <label>金額（税込）</label>
        <input type="number" name="fareAmount[]" step="100">
      </div>
